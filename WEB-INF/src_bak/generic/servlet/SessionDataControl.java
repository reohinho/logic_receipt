...
public class SessionDataControl 
{
  ...
  /** Keeps the last access time of the object */
  Hashtable objRefGroupName = new Hashtable () ;
  ...
  public String toString() { 
    ...
    while (enumKeys.hasMoreElements()) 
    {
      ...
      String refGroupName = (String)objRefGroupName.get((Integer)iIdx) ;
      s += ("Idx:<" + iIdx.intValue() + ">  Last Access:<" + lastAcc.toString() + ">  " +ht.get((Integer)iIdx)) + "  Ref. group name:<" + refGroupName + "> \n" ;
    }
    return s ;
  }
  ...
  public String getObjectRefGroupNameByIndex (int idx) {
    return (String)objRefGroupName.get(new Integer(idx)) ;
  }
...
//      return ht.get(new Integer(iIdx)) ;
  ...
  public synchronized int newObject (String refGroup, Object obj) {
    ...
    objRefGroupName.put (new Integer(iNumObj), (String)refGroup) ;
    maxNumCreated ++ ;
    return iNumObj;
  }
  ...
  public synchronized void removeObjectFromExistingIndex (int idx) {
    try {
      ...
      objRefGroupName.remove((Integer) iIdx) ;
