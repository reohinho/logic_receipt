...
/*
Report layout for Total Transaction Report
...
public class DailyTransactionReportGenerate  {
  ArrayList data;
  ReportEnquiryData reData;
  public DailyTransactionReportGenerate(ArrayList data, ReportEnquiryData reData) {
    try {
      this.data = data;
      this.reData = reData;
    }catch(Exception e) {
...
System.out.println("data size="+data.size());
        ...
        for(int i=0; i<data.size();i++) {
		  ...
		  else if (row[7].equals("Y"))	//2013-02-21 if void flag = Y, add cash and cheque to void amount
		  {
		...
		table.addCell(printStr("Total Amount Banked: HK$ ",16,12,false,PdfPCell.NO_BORDER,0));
    ...
    class MyPageEvents extends PdfPageEventHelper { //Override iText's class to handle total page number.
	    ...
	    //subtab1.addCell(printStr("Period End Date: "+reData.getData(reData.periodEnd),1,8,false,PdfPCell.NO_BORDER,0));
          ...
          //sub table 2
            ...
            subtab2.addCell(printStr("TOTAL TRANSACTIONS REPORT",1,12,true,PdfPCell.NO_BORDER,1));
          ...
          //sub table 3  
            ...
            table.addCell(printStr("Receipt Date",1,10,true,PdfPCell.LEFT+PdfPCell.RIGHT+PdfPCell.TOP+PdfPCell.BOTTOM,0)); 
