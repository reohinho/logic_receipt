...
public class DailyTransactionOfficerReport extends MasterServlet   {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
	...
	try {
	  ...
	  response.setHeader("Content-Disposition", "attachment; filename=\"DailyTransactionOfficerReport.pdf\"");
      ...
      ArrayList data = rptDrv.getDailyTransactionOfficerReportData(reData);
      DailyTransactionOfficerReportGenerate gen = new DailyTransactionOfficerReportGenerate(data, reData);
