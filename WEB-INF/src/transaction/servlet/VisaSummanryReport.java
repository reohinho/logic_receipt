...
public class VisaSummanryReport extends MasterServlet   {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
	...
	try {
	  ...
	  response.setHeader("Content-Disposition", "attachment; filename=\"VisaSummaryReport.pdf\"");
      ...
      ArrayList data = rptDrv.getVisaSummaryReportData(reData);
      VisaSummaryReportGenerate gen = new VisaSummaryReportGenerate(data, reData);
