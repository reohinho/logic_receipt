...
// get view object from caller  
  HolidaySearchFormData vo = (HolidaySearchFormData) request.getAttribute(IBaseConstants.kGenericWebFormData) ;
  if (vo == null) 
...
<form name="form1" method="post" action="<%= servletLocation %>">
    ...
    <fieldset>
    <legend><u>Holiday Search</u><u></u></legend>
    ...
    <tr>
        ...
        <%=wfg.htmlFieldInput(vo.holidayDate, 10)%>
        </div></td>
      </tr>
      <tr>
        <td align="left" class="oneColElsCtrHdr" width="129">
