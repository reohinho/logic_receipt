...
//Servlet Info
  String servletName = "BankCodeCreateServlet" ;
...
// get view object from caller  
  ...
  boolean canSearch = GeneralDataInHtml.isAccessible(userId, "BS");
...
<form name="form1" method="post" action="<%= servletLocation %>">
 ...
 <form name="searchItem" method="post" action="BankCodeSearchServlet"  >
  <input type="hidden" name="<%= IBaseConstants.kCommand %>" value="">
</form>
<!-- end #container --></div>
</body>
