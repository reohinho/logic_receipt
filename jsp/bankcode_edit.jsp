...
//Servlet Info
  String servletName = "BankCodeEditServlet" ;
...
<form name="form1" method="post" action="<%= servletLocation %>">
    ...
    <tr>
      ...
      <tr>
        ...
        <input type="button" name="delete" id="delete" value="Delete" onClick="document.form1.action='BankCodeDeleteServlet' ; dispatch('<%=IViewDeleteWorkFlow.kDelete %>')"/>
