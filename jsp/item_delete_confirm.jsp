...
//Servlet Info
  String servletName = "ItemDeleteServlet" ;
...
<input type="button" name="Submit2" value="No" onClick="dispatch('<%=IViewDeleteWorkFlow.kDeleteBack %>');">
    ...
    <tr>
      ...
      <tr>
        ...
        <td align="left" class="oneColElsCtrHdr">
        <select readonly="true" name="<%=vo.getFieldname(vo.itemType)%>" id="<%=vo.getFieldname(vo.itemType)%>">
      ...
      <tr>
        ...
        <td colspan="4" align="center"><div align="left">
          <select readonly="true" name="<%=vo.getFieldname(vo.paymentType)%>" id="<%=vo.getFieldname(vo.paymentType)%>">
