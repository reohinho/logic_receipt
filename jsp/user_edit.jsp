...
//Servlet Info
  String servletName = "UserEditServlet" ;
...
<form name="form1" method="post" action="<%= servletLocation %>">
    ...
    <tr>
      ...
      <tr>
        ...
        <td colspan="4" align="left" class="oneColElsCtrHdr"><div align="left">
         <%=wfg.htmlFieldInput(vo.password, 10)%>
        </div></td>
      </tr>
      <tr>
        <td align="left" class="oneColElsCtrHdr" width="129">
      ...
      <tr>
        ...
        <input type="button" name="delete" id="delete" value="Delete" onClick="document.form1.action='UserDeleteServlet' ; dispatch('<%=IViewDeleteWorkFlow.kDelete %>')"/>
