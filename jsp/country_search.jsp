...
// get view object from caller  
  CountrySearchFormData vo = (CountrySearchFormData) request.getAttribute(IBaseConstants.kGenericWebFormData) ;
  if (vo == null) 
...
<form name="form1" method="post" action="<%= servletLocation %>">
    ...
    <fieldset>
    <legend><u>Country Search</u><u></u></legend>
    ...
    <tr>
        ...
        <%=wfg.htmlFieldInput(vo.countryCode, 10)%>
        </div></td>
      </tr>
      <tr>
        <td align="left" class="oneColElsCtrHdr" width="129">
