...
// get view object from caller  
  UserSearchFormData vo = (UserSearchFormData) request.getAttribute(IBaseConstants.kGenericWebFormData) ;
  if (vo == null) 
...
<form name="form1" method="post" action="<%= servletLocation %>">
    ...
    <fieldset>
    <legend><u>User Search</u><u></u></legend>
    ...
    <tr>
        ...
        <%=wfg.htmlFieldInput(vo.userId, 10)%>
        </div></td>
      </tr>
      <tr>
        <td align="left" class="oneColElsCtrHdr" width="129">
