...
// get view object from caller  
  ...
  boolean canSearch = GeneralDataInHtml.isAccessible(userId, "IS");
...
<form name="form1" method="post" action="<%= servletLocation %>">
    ...
    <tr>
        ...
        <td colspan="4" align="left" class="oneColElsCtrHdr"><div align="left">
         <input type="button" name="search" id="search" value="Search" <%if(!canSearch){%>disabled=true<%}%>  onclick="document.searchItem.submit();"/>
        </div></td>
      </tr>
      <tr>
        <td align="left" class="oneColElsCtrHdr" width="129">
 ...
 <form name="searchItem" method="post" action="ItemSearchServlet"  >
  <input type="hidden" name="<%= IBaseConstants.kCommand %>" value="">
</form>
<!-- end #container --></div>
</body>
