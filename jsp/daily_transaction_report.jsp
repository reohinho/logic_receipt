...
//Page Info
  String thisPageID = "RP_DTRP" ;

//Servlet Info
  String servletName = "DailyTransactionReport" ;
...
<form name="form1" method="post" action="<%= contextServletPath+servletLocation %>">
    ...
    <fieldset>
    <legend><u>Total Transactions Report</u><u></u></legend>
    ...
    <tr>
	   ...
	   <a href="javascript:NewCal('periodStart','ddmmyyyy',true,24)"><img src="../img/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
        </div></td>
      </tr>
      <tr>
        <td align="left" class="oneColElsCtrHdr" >
	   ...
	   <a href="javascript:NewCal('periodEnd','ddmmyyyy',false,24)"><img src="../img/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
        </div></td>
      </tr>
      <tr>
      	<td align="left" class="oneColElsCtrHdr" >
